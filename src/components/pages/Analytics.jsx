        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900">{metrics.sales}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Total Revenue:</span>
              <span className="font-medium text-gray-900">${metrics.revenue.toFixed(2)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Average Order:</span>
              <span className="font-medium text-gray-900">${metrics.avgOrder.toFixed(2)}</span>
            </div>
            <div className="flex justify-between pt-2 border-t border-gray-200">
              <span className="text-gray-600">Best Seller:</span>
              <span className="font-medium text-amber-600">{metrics.topProduct}</span>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            <div className="text-center p-3 bg-green-50 rounded-lg">
              ...
              <div className="text-sm text-green-700">Units Sold</div>
            </div>
            <div className="text-center p-3 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">
                {new Set(filteredSales.map(sale => sale.productId)).size}
              </div>
              <div className="text-sm text-blue-700">Products Sold</div>
            </div>
          </div>
        </Card>
            ...
            <div className="p-3 bg-amber-50 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-sm text-amber-700">
                  ...
                  <p>{metrics.topProduct} is your best seller</p>
                </div>
              </div>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-sm text-gray-700">
                  ...
                  <p>Consider promoting lower-performing products</p>
                </div>
              </div>
            </div>
          </div>
